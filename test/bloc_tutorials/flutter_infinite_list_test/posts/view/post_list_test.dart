...
import 'package:bloc_docs_tutorials/bloc_tutorials/flutter_infinite_list/posts/models/post.dart';
import 'package:bloc_docs_tutorials/bloc_tutorials/flutter_infinite_list/posts/view/posts_list.dart';
import 'package:bloc_docs_tutorials/bloc_tutorials/flutter_infinite_list/posts/widgets/bottom_loader.dart';
import 'package:bloc_docs_tutorials/bloc_tutorials/flutter_infinite_list/posts/widgets/post_list_item.dart';
    ...
    testWidgets('fetches more posts when scrolled to the bottom', (
      ...
      when(() => postBloc.state).thenReturn(
        PostState(
          ...
          posts: List.generate(
            10,
            (i) => Post(id: 1, title: 'post title', body: 'post body'),
          ),
        ),
      );

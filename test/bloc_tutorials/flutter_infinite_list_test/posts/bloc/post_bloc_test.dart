...
Uri _postUrl({required int start}) {
  ...
  group('PostBloc', () {
    ...
    group('PostFetched', () {
      ...
      blocTest<PostBloc, PostState>(
        ...
        verify: (_) {
          verify(() => httpClient.get(_postUrl(start: 0))).called(1);
        },
      );
      ...
      blocTest<PostBloc, PostState>(
        ...
        verify: (_) {
          verify(() => httpClient.get(_postUrl(start: 1))).called(1);
        },
      );
      ...
      blocTest<PostBloc, PostState>(
        ...
        build: () => PostBloc(httpClient: httpClient),
        seed: () => PostState(status: PostStatus.success, posts: mockPosts),
        act: (bloc) => bloc.add(PostFetched()),
        expect: () => const <PostState>[
          PostState(
            status: PostStatus.success,
